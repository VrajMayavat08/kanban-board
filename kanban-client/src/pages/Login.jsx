  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm glass-card rounded-2xl p-8">
        ...
        <p className="text-[var(--color-text-secondary)] text-sm mb-6">Log in to your boards</p>
        {error && (
        ...
        <p className="text-sm text-[var(--color-text-secondary)] mt-6 text-center">
          No account? <Link to="/register" className="text-[var(--color-violet-light)]">Sign up</Link>
        </p>
      </div>
    </div>
  );
